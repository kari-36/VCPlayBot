...
@Client.on_message(command(["startvc", f"start@{BOT_USERNAME}"]) & filters.private & ~filters.edited)
...
@Client.on_message(command(["startvc", f"start@{BOT_USERNAME}"]) & filters.group & ~filters.edited)
...
@Client.on_message(command(["helpvc", f"help@{BOT_USERNAME}"]) & filters.group & ~filters.edited)
...
@Client.on_message(command(["helpvc", f"help@{BOT_USERNAME}"]) & filters.private & ~filters.edited)
